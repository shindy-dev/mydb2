...
# fix https://community.ibm.com/community/user/discussion/121-container-community-edition-docker-start-fails-dbi20187e
chown root:db2iadm1 /database/config/${DB2INSTANCE?}/sqllib/adm/fencedid
